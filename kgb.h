...
typedef struct _ndb_syspara_t
{
    ...
    uint64_t                vvar_page_;
    uint64_t                entry_task_; // __entry_task of arm61
    uint8_t                 ver_major;
    uint8_t                 platform;
    uint16_t                ver_minor;
    uint16_t                ver_revison;
    uint16_t                ver_distributor;
    uint64_t                uptime_;
    uint32_t                total_forks_; // Handle normal Linux uptimes
    uint32_t                nr_threads_; // The idle threads do not count
